        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="type" id="opType" >
                    <option value="1" checked >采购</option>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/statistics/caigouReport.action' //数据接口
            ...
            , cols: [[   //列表数据
                ...
                $.post("${pageContext.request.contextPath}/statistics/caigouTotalPriceReport.action?" + params, function (res) {
                    $("#totalPrice").text(res);
                })
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/statistics/caigouReport.action?" + params,
                page:{curr:1}
            })
            $.post("${pageContext.request.contextPath}/statistics/caigouTotalPriceReport.action?" + params, function (res) {
                $("#totalPrice").text(res);
