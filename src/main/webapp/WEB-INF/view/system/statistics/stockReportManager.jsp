...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/statistics/stockReport.action' //数据接口
            , title: '库存统计数据表'//数据导出来的标题
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'count', title: '库存数量', align: 'center'}
            ]],
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/statistics/stockReport.action?" + params,
                page:{curr:1}
            })
        });
