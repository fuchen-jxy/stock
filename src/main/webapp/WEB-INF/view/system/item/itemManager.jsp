...
<form class="layui-form" method="post" id="searchFrm">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px">
                <input type="text" name="code" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入商品编码" style="height: 30px;border-radius: 10px">
            </div>
            <button type="button"
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">商品编码:</label>
                <div class="layui-input-inline">
                    <input type="text" name="code" lay-verify="required" placeholder="请输入商品编码" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="properties" lay-verify="required" placeholder="请输入商品属性" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="price" lay-verify="required" placeholder="请输入商品成本价" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="supplier" id="searchsupplier" lay-filter="searchsupplier">
                </select>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/item/loadAllItem.action' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/item/loadAllItem.action?" + params,
                page:{curr:1}
            })
        });
        ...
        table.on('tool(userTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.name + '】这个商品么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${pageContext.request.contextPath}/item/deleteItem.action", {id: data.id}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
        ...
        function openAddUser() {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    $.get("${pageContext.request.contextPath}/supplier/loadAllSupplierJson.action",function(res){
                        var users=res;
                        console.log(res);
                    ...
                    url = "${pageContext.request.contextPath}/item/addItem.action";
                }
            });
        }
        ...
        function openUpdateUser(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    form.render();
                    url = "${pageContext.request.contextPath}/item/updateItem.action";
                }
            });
        }
        ...
        function deleteBatch() {
            ...
            layer.confirm('真的要删除这些商品么？', function (index) {
                //向服务端发送删除指令
                $.post("${pageContext.request.contextPath}/item/deleteBatchItem.action",params, function (res) {
                    layer.msg(res.msg);
                    //刷新数据表格
                    tableIns.reload();
                })
