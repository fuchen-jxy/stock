...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${pageContext.request.contextPath}/supplier/loadAllSupplier.action' //数据接口
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'status', title: '状态', align: 'center', templet: function (d) {
                        return d.status == 1 ? '<font color=blue>合作</font>' : '<font color=red>停止合作</font>';
                    }}
        ...
        $("#doSearch").click(function () {
            ...
            //alert(params);
            tableIns.reload({
                url: "${pageContext.request.contextPath}/supplier/loadAllSupplier.action?" + params,
                page:{curr:1}
            })
        });
