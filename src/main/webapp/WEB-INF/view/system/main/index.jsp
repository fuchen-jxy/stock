...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${pageContext.request.contextPath}/static/images/face.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite
                            class="adminName">${user.username}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}" class="signOut"><i
    ...
    <!-- 左侧导航 -->
    <div class="layui-side layui-bg-black" style="overflow: auto;">
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${pageContext.request.contextPath}/static/page/main.html"><i class="layui-icon"
